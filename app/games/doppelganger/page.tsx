...
export default function Doppelganger() {
  const gameSchema = {
    ...
    description:
      "Doppelgänger is a social deduction card game for 3-6 players where players try to identify the hidden Doppelgänger while keeping their own identity secret.",
  ...
  return (
    <>
      <Head>
        <title>
          Doppelgänger - A Social Deduction Card Game for 3-6 Players
        </title>
        <meta
          name="description"
          content="Learn how to play Doppelgänger, a social deduction card game for 3-6 players. Read the rules, strategies, and variations."
        />
        ...
        <div className="card w-full lg:w-1/2 bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <ul className="list-disc list-inside mb-4">
              ...
              <li>
                The doppelganger’s goal is to blend in with the rest of the
                group and avoid suspicion.
              </li>
              <li>
                After each round, players vote on who they think the
                doppelganger is. If the doppelganger is correctly identified,
                that player loses. If the group guesses wrong, the doppelganger
                wins.
              </li>
            </ul>
            ...
            <p className="mb-4">
              ...
              commonly found in folklore and mythology. The game plays on the
              idea of deception and imitation, with players trying to hide their
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                ...
                such as forcing another player to reveal a card or swapping
                cards with someone secretly.
              </li>
              <li>
                Another version allows for multiple doppelgangers, increasing
                the difficulty for non-doppelganger players to find them.
              </li>
              <li>
            ...
            <ul className="list-disc list-inside mb-4">
              ...
              <li>
                Players may jump to conclusions too quickly, leading to
                incorrect votes and allowing the doppelganger to win.
              </li>
              <li>
                Overcomplicating the questioning or strategy can confuse
                players, making it easier for the doppelganger to stay hidden.
              </li>
            </ul>
