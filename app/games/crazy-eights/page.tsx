...
export default function CrazyEights() {
  const gameSchema = {
    ...
    description:
      "Crazy Eights is a fast-paced card game for 2 to 7 players, where players aim to be the first to get rid of all their cards by matching the rank or suit of the previous card.",
    url: "https://cardmaster.dev/games/crazy-eights",
  };
  return (
    <>
      <Head>
        <title>Crazy Eights - A Card Game for 2-7 Players</title>
        <meta
          name="description"
          content="Learn how to play Crazy Eights, a fast-paced card game for 2-7 players. Read the rules and strategies."
        />
        ...
        <div className="card w-full lg:w-1/2 bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <p className="mb-4">
              ...
              The game gained popularity because it was simple to learn and
              didn't require any special equipment beyond a standard deck of
              cards. Its name comes from the fact that eights are wild, giving
              players a powerful move that can turn the tide of the game. Over
              time, various regional versions and house rules have evolved,
              making Crazy Eights a versatile and globally beloved card game.
            </p>
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                Crazy Eights is typically played with 2-7 players using a
            ...
            <ul className="list-disc list-inside mb-4">
              ...
              <li>
                Eights are wild and can be played at any time, allowing the
                player to declare the next suit to be played.
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                <strong>Crazy Jacks:</strong> In this variation, Jacks become
                wild cards as well, adding a twist to the game.
              </li>
              <li>
              ...
              <li>
                <strong>Skip:</strong> Certain cards (like a Queen or a Jack)
                can cause the next player to lose their turn.
              </li>
              <li>
                <strong>Reverse:</strong> Similar to Uno, some versions of Crazy
                Eights include a rule where a certain card (like a King)
            ...
            <p className="mb-4">
              While Crazy Eights is primarily a game of luck, a few strategic
              tips can help increase your chances of winning:
            </p>
            <ul className="list-disc list-inside mb-4">
              <li>
              ...
              <li>
                ...
                cards that have been played. This will help you predict what
                cards are left and what suits might be more difficult for your
                opponents.
              </li>
              <li>
                <strong>Avoid Drawing if Possible:</strong> Try to match suits
                and ranks early on to avoid having to draw cards. The more cards
                you have, the harder it will be to win.
              </li>
              <li>
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                ...
                tempting to play an eight as soon as you have one, using them
                too early can leave you vulnerable later in the game.
              </li>
              <li>
                <strong>Not Changing the Suit:</strong> Failing to change the
                suit when you play an eight can give your opponents an
                advantage. Always choose a suit that benefits your hand or
                disrupts your opponents’ strategies.
              </li>
              <li>
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                <strong>Eights:</strong> When a player plays an eight, they get
                to choose the next suit to be played. The next player must play
                a card of the chosen suit or another eight.
              </li>
              <li>
                <strong>Draw Two:</strong> Some variations include a rule where
                a player who cannot play a card and has to draw must draw two
