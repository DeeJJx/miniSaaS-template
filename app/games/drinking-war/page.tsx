      ...
      <div className="card w-full lg:w-1/2 bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <p className="mb-4">
            ...
            opponent by playing higher cards and forcing them to drink when they
            lose a round.
          </p>
          ...
          <p className="mb-4">
            ...
            them at the bottom of their pile. If the cards are of equal rank, a
            "war" occurs, where both players place three cards face down and
            then flip another card. The player with the higher card takes all
            the cards. If there's another tie, the process repeats.
          </p>

          <h2 className="card-title text-2xl font-bold">Losing and Drinking</h2>
          <p className="mb-4">
            The losing player must take a drink for each card they lose in that
            round. This can escalate quickly, especially during wars, making for
            a lively game.
          </p>
          ...
          <p className="mb-4">
            Drinking War is a variation of the classic card game War, where the
            competitive spirit of the original game is amplified with the
            addition of drinking penalties. It is popular at parties and social
            gatherings, providing both entertainment and a light-hearted way to
          ...
          <ul className="list-disc list-inside mb-4">
            <li>
              <strong>Multiple Decks:</strong> For larger groups, consider using
              multiple decks to increase the number of cards in play.
            </li>
            <li>
            ...
            <li>
              <strong>Speed War:</strong> Players must flip their cards within a
              set time limit to keep the game moving quickly.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              <strong>Stay Engaged:</strong> Focus on the game to react quickly
              during "wars," as this can impact how many cards you lose.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside mb-4">
            <li>
              <strong>Not Paying Attention:</strong> Failing to focus can result
              in missed rounds or mistakes during "wars."
            </li>
            <li>
