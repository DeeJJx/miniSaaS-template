    ...
    <main className="flex min-h-screen flex-col items-center justify-start p-12 bg-base-200">
      ...
      <div className="card w-full lg:w-1/2 bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <p className="mb-4">
            Blackjack, also known as 21, is one of the most popular casino card
            games worldwide. Its origins can be traced back to a game called
            "Vingt-et-Un" (meaning 21 in French), which appeared in French
            casinos around the 1700s. The modern version of Blackjack became
            popular in the United States in the 1800s, especially after casinos
            started offering a 10-to-1 payout for a hand featuring an Ace of
            Spades and a Black Jack (hence the name "Blackjack"). Over time,
            Blackjack has evolved into a game enjoyed by both casual players and
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              ...
              worth 10, and Aces can be worth 1 or 11.
            </li>
            <li>
            ...
            <li>
              The player's goal is to beat the dealer by having a hand closer to
              21 without going over (busting).
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              <strong>Blackjack Switch:</strong> Players are dealt two hands and
              can switch their top cards to improve their odds.
            </li>
          </ul>
          ...
          <p className="mb-4">
            Blackjack is a game of both luck and strategy. Using basic strategy
            can significantly improve your odds of winning. Here are some key
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              <strong>Split Aces and Eights:</strong> Always split Aces and 8s.
              Splitting Aces gives you the chance to form two strong hands, and
              splitting 8s helps you avoid a hard 16, which is one of the worst
              hands in Blackjack.
            </li>
            <li>
            ...
            <li>
              <strong>Avoid Insurance Bets:</strong> Insurance is generally not
              a good bet. It offers poor odds and should be avoided unless
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              ...
              can lead to losing your bankroll quickly. It’s important to manage
              your money and stick to a budget.
            </li>
            <li>
              <strong>Misunderstanding Soft Hands:</strong> Players often don't
              understand how to play "soft" hands (hands containing an Ace).
              Remember that a soft 18 is better played as a Hit rather than a
              Stand when the dealer has a strong upcard.
            </li>
            <li>
